...
const GardenFrequencyV = () => {
  ...
  let gardenFrequency = [
    { name: moment(`${year}01`, "YYYYMM").format("MMM[/]YY"), posts: 2 },
    { name: moment(`${year}02`, "YYYYMM").format("MMM[/]YY"), posts: 2 },
    { name: moment(`${year}03`, "YYYYMM").format("MMM[/]YY"), posts: 1 },
    { name: moment(`${year}04`, "YYYYMM").format("MMM[/]YY"), posts: 2 },
    { name: moment(`${year}05`, "YYYYMM").format("MMM[/]YY"), posts: 0 },
    { name: moment(`${year}06`, "YYYYMM").format("MMM[/]YY"), posts: 1 },
    { name: moment(`${year}07`, "YYYYMM").format("MMM[/]YY"), posts: 1 },
    { name: moment(`${year}08`, "YYYYMM").format("MMM[/]YY"), posts: 1 },
    ...
    { name: moment(`${year}12`, "YYYYMM").format("MMM[/]YY"), posts: 1 },
  ];
