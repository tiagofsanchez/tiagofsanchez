...
And there you go! Now, you can check some of my favorite surf spots and the plance where I came from :). If you want to check out the app click on the [link](https://tiago-surfspots.netlify.app/).
